...
public class AdvisorUtil {
	public static ArrayList<Group> getGroups( String xml) {
		try {
	...
	public static ArrayList<Profile> getProfiles( String xml) {
		try {
	...
	public static ArrayList<Alias> getAliases( String xml) {
		try {
